# Ledger Matrix AI app
[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
[![GithubActions](https://github.com/Zondax/ledger-matrix/actions/workflows/main.yml/badge.svg)](https://github.com/Zondax/ledger-matrix/blob/main/.github/workflows/main.yaml)
...
This project contains the Matrix AI app for Ledger Nano S Nano S+, X ans Stax.

- Ledger Nano S/S+/X and Stax Matrix AI app
- Specs / Documentation
- C++ unit tests
- Zemu tests
...
Download a release from here (https://github.com/Zondax/ledger-matrix/releases). You only need `installer.sh`
