...
__Z_INLINE void app_sign() {
    ...
    zxerr_t err = crypto_sign(G_io_apdu_buffer, &signatureLength, IO_APDU_BUFFER_SIZE - 3, message, messageLength);
    ...
    if (err != zxerr_ok) {
        ...
        set_code(G_io_apdu_buffer, signatureLength, APDU_CODE_OK);
        io_exchange(CHANNEL_APDU | IO_RETURN_AFTER_TX, signatureLength + 2);
    }
}
